namespace BLL.Interface.Interfaces
{
    ...
    public interface IAccountService
    {
        ...
        /// <param name="idGenerator">ID creator service.</param>
        void OpenAccount(string owner, AccountGrade grade, IAccountIdGenerator idGenerator);
        ...
        IAccountRepresentation GetAccount(Guid id);

        /// <summary>
        /// Gets all available accounts in an underlying repository.
        /// </summary>
        /// <returns>Collection of <see cref="IAccountRepresentation"/> instances.</returns>
        IEnumerable<IAccountRepresentation> GetAllAccounts();
    }
}
