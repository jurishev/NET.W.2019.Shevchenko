namespace DAL.Interface.Interfaces
{
    ...
    public interface IAccountRepository
    {
        ...
        /// </summary>
        /// <param name="data">Data to create a new record with.</param>
        void AddRecord(IAccountDto data);
        ...
        /// </summary>
        /// <param name="data">Data to update a record with.</param>
        void UpdateRecord(IAccountDto data);
    }
}
